...
train_model(X_profiling, Y_profiling, cnn_best_model,
            ascad_trained_models_folder + "my_cnn_best_desync0_epochs75_batchsize200.h5", epochs=75, batch_size=200)
#### Desync = 50
# cnn_best_model = cnn_best()
...
# train_model(X_profiling, Y_profiling, mlp_best_model,
#             ascad_trained_models_folder + "my_mlp_best_desync0_epochs200_batchsize100.h5", epochs=200, batch_size=100)
#### Desync = 50
# mlp_best_model = mlp_best()
